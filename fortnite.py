...
print(crayons.cyan(f'\nIKONIK BOT. '
                   'Credit to Terbau for creating the library  ＢＩＮＧＯ 
██████╗░██╗███╗░░██╗░██████╗░░█████╗░
██╔══██╗██║████╗░██║██╔════╝░██╔══██╗
██████╦╝██║██╔██╗██║██║░░██╗░██║░░██║
██╔══██╗██║██║╚████║██║░░╚██╗██║░░██║
██████╦╝██║██║░╚███║╚██████╔╝╚█████╔╝
╚═════╝░╚═╝╚═╝░░╚══╝░╚═════╝░░╚════╝░ .'))
print(crayons.cyan(f'Discord server: https://discord.gg/vHqydv2🅱🅸🅽🅶🅾 - For support, questions, etc.'))
...
async def accept_ping(request: sanic.request.Request) -> None:
    return sanic.response.json({"status": "online gg ikonik bot oline"})
...
class AuraBot(commands.Bot):
    def __init__(self, email : str, password : str, **kwargs) -> None:
        self.status = '🔥 USECODE : neutro 🔥  BINGOOO'
        ...
        self.server = server
        self.welcome_message = "Hey {DISPLAY_NAME} Join discord.gg/vHqydv2 for a free lobby bot!"
        self.whisper_message = "If you need help or want your own bot, Join discord.gg/vHqydv2"
